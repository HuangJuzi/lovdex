...
export const AskUserQuestionPanel: React.FC<PermissionPanelProps> = ({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl border border-border bg-card shadow-lg dark:shadow-2xl">
        {/* Accent line */}
        <div className="absolute left-0 right-0 top-0 h-[2px] bg-gradient-to-r from-primary via-chart-1 to-chart-3" />
        ...
        <div className="px-4 pb-2 pt-3.5">
          <div className="mb-1.5 flex items-center gap-2.5">
            ...
            <div className="relative flex-shrink-0">
              <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-gradient-to-br from-primary/10 to-chart-1/10">
              ...
              <div className="absolute -right-0.5 -top-0.5 h-2 w-2 animate-pulse rounded-full bg-chart-1" />
            </div>
