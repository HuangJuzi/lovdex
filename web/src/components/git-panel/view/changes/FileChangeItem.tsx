      ...
      <div className={`flex items-center transition-colors hover:bg-accent/50 ${isMobile ? 'px-2 py-1.5' : 'px-3 py-2'}`}>
        ...
        <div className="flex min-w-0 flex-1 items-center">
          ...
          <span className="flex items-center gap-1">
            ...
            <span
              className={`inline-flex h-5 w-5 items-center justify-center rounded border text-3xs font-bold ${badgeClass}`}
              title={statusLabel}
            >
              {status}
            </span>
      ...
      >
        <div className="flex items-center justify-between border-b border-border p-2">
          <span className="flex items-center gap-2">
            <span className={`inline-flex h-5 w-5 items-center justify-center rounded border text-3xs font-bold ${badgeClass}`}>
              {status}
            </span>
