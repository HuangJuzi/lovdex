    ...
    <div ref={containerRef} className={`flex h-full min-w-0 ${editorExpanded ? 'flex-1' : ''}`}>
      {!editorExpanded && (
        <div
          ...
          className="group relative w-1 flex-shrink-0 cursor-col-resize bg-border transition-colors hover:bg-primary"
      ...
      <div
        className={`h-full overflow-hidden border-l border-border ${useFlexLayout ? 'min-w-0 flex-1' : `min-w-[${MIN_EDITOR_WIDTH}px] flex-shrink-0`}`}
