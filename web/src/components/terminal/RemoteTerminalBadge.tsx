...
export function RemoteTerminalBadge({ hostName }: { hostName?: string | null }) {
  ...
  return (
    <div className="pointer-events-none absolute right-2 top-2 z-10 flex items-center gap-1 rounded-full border border-indigo-300/40 bg-indigo-950/80 px-2 py-0.5 text-2xs font-medium text-indigo-200">
